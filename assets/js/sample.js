...
var LinkButton = React.createClass({displayName: "LinkButton",
    ...
    render: function() {
        var glyph = this.props.glyph ? (React.createElement(Glyphicon, {glyph: this.props.glyph})) : (React.createElement("span", null));
        return (
            React.createElement(Button, {bsStyle: this.props.style, onClick: this.handleClick}, 
                glyph, 
                this.props.text
            )
        );
...
},{"react":236,"react-bootstrap":67}],241:[function(require,module,exports){
'use strict';
...
},{"./_link-button.jsx":240,"react":236,"react-bootstrap":67,"superagent":237}]},{},[241]);
