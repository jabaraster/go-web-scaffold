...
const (
    KeyMode = "ENV_MODE"
    KeyDbKind = "ENV_DB_KIND"
    KeyPostgresHost     = "ENV_POSTGRES_HOST"
    KeyPostgresDbName   = "ENV_POSTGRES_DB_NAME"
    KeyPostgresUser     = "ENV_POSTGRES_USER"
    KeyPostgresPassword = "ENV_POSTGRES_PASSWORD"
    KeyPostgresSslMode  = "ENV_POSTGRES_SSL_MODE"
